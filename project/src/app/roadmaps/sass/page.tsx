      ...
      <div className="mx-auto grid max-w-[1280px] grid-cols-1 lg:grid-cols-[225px_minmax(0,1fr)]">
        <aside className="hidden min-h-[calc(100vh-68px)] border-r border-[var(--border)] px-5 py-5 lg:block">
          <div className="sticky top-[102px] rounded-lg border border-[var(--border)] bg-[var(--panel-bg)] p-5 shadow-2xl shadow-[var(--shadow)]">
            ...
            <p className="mt-6 text-xs font-black uppercase tracking-[0.18em] text-pink-500">Roadmap</p>
            ...
            <div className="mt-9 rounded-lg border border-pink-500/25 bg-black/20 p-4">
              <div className="grid h-16 w-full place-items-center rounded-md border border-pink-500/35 bg-black/40 text-4xl font-black text-pink-500">
                Sass
              </div>
        ...
        <section className="px-5 py-6 sm:px-8 lg:px-8">
          <div className="mx-auto max-w-[1040px]">
            ...
            <section className="mt-6 grid gap-6 xl:grid-cols-[minmax(0,1fr)_255px]">
              ...
              <div className="relative min-h-[250px] overflow-hidden rounded-lg border border-pink-500/25 bg-black shadow-[0_0_80px_rgba(236,72,153,0.16)]">
                ...
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-6xl font-black text-pink-400 drop-shadow-[0_0_28px_rgba(236,72,153,0.7)]">
                  Sass
                </div>
              </div>
            </section>
